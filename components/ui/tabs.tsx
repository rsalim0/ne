  ...
  return (
    <TabsPrimitive.List
      className={cn(
        ...
        variant === "default"
          ? "rounded-lg bg-surface-2 p-0.5 text-muted-foreground/72"
          : "data-[orientation=vertical]:px-1 data-[orientation=horizontal]:py-1 *:data-[slot=tabs-tab]:hover:bg-surface-2",
        className,
      )}
      data-slot="tabs-list"
      {...props}
